...
genes_to_cuis = pickle.load(open('../rscs/Pfx050120_merged_genes_to_cuis.pkl','rb'))
cui_to_phens = pickle.load(open('../rscs/Pfx050120_cui_to_phens.pkl','rb'))
expect_pvals = pickle.load(open('../results/Pfx050120random_networks/Pfx050120_expected_pvalue_summary.pkl','rb'))
phen_to_cui = pickle.load(open('../rscs/Pfx050120_all_phens_to_cuis.pkl','rb'))
cui_to_genes = pickle.load(open('../rscs/Pfx050120_merged_unique_cuis2genes.pkl','rb'))
intome_size = pickle.load(open('../rscs/pfx041520_intome_size.pkl','rb'))
sourced_phens = pickle.load(open('../rscs/Pfx050120_sourced_phens.pkl','rb'))
